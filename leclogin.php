...
<body style="color:rgb(255, 255, 255); background-color:#0b90d3">
    <div class="container mt-5">
        <div class="text-center">
            <h1 class="display-5 mb-5"><strong> Lecturer Login </strong></h1>
        </div>
        <div class="main row justify-content-center">
            <form method="POST" action="lecturer.php" id="leclogin-form" class="row justify-content-center mb-4">
